...
/**
 * Created by qiong.peng on 2017/4/18.
 * 给图片加水印工具类
 */
public class WaterMarkImageUtil {
    ...
    // 水印内容, 默认使用此内容
    private final static String LOGO_TEXT = "此图片仅供青蓝白条使用";
...
//            g.drawString(logoText, positionWidth, positionHeight);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String logoText = "此 图 片 仅 供 青 蓝 白 条 内 部 使 用";
...
//        File file = new File("C:\\Users\\Public\\Pictures\\Sample Pictures\\Desert.jpg");
        ...
        File file = new File("D:\\b.jpg");
        String aIconPath = WaterMarkImageUtil.class.getResource("/img/waterMarkIcon.png").getPath();
//        String aIconPath = "D:\\水印4.png";
        InputStream is = markImageByIcon(aIconPath, new FileInputStream(file), -30, null);
